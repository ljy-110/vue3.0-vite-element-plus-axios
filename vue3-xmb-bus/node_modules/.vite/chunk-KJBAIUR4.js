  ...
  const suspense = {
    ...
    registerDep(instance, setupRenderEffect) {
      ...
      instance.asyncDep.catch((err) => {
        ...
        setupRenderEffect(instance, vnode2, parentNode(hydratedEl || instance.subTree.el), hydratedEl ? null : next(instance.subTree), suspense, namespace, optimized);
        if (placeholder) {
          remove2(placeholder);
        }
...
* @license MIT
**/
//# sourceMappingURL=chunk-KJBAIUR4.js.map
